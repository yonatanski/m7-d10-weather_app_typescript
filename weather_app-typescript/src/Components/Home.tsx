          ...
          {searchedCity ? (
            <Card className="mt-4 bg-dark">
              ...
              <Card.Body>
                ...
                <Card.Title>{searchedCity.list[0].main.temp} </Card.Title>
            ...
            <>
              <Col xs="12" md="6" style={{ marginTop: "3.5rem" }}>
                <Col xs="12">
                  <Card style={{ backgroundColor: "black", marginBottom: "2rem", borderRadius: "10%", width: "75%" }}>
                    <Card.Img src={`http://openweathermap.org/img/wn/${warsaw?.list[0].weather[0].icon}@2x.png`} />
                    <Card.ImgOverlay>
                      <Card.Title style={{ fontSize: "1.8rem", fontWeight: "bold" }}>{warsaw?.city.name}</Card.Title>
                      <Card.Text>
                        {warsaw?.list[0].weather[0].main} <span style={{ color: "blue" }}> {warsaw?.list[0].main.temp}C° </span>
                      </Card.Text>
